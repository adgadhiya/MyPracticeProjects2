...
import com.example.unknown.travistutorial.helper.DatabaseHelper;
import com.example.unknown.travistutorial.helper.Tag;
import com.example.unknown.travistutorial.helper.Todo;

import java.util.List;

public class SQLiteActivityClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sqlite_activity_class);
        ...
        List<Todo> tagsWatchList = db.getAllToDoByTag(tag3.getTag_name());
